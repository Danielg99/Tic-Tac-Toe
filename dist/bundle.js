...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.score-x').text(scoreX)
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.score-o').text(scoreO)


const printX = (element) => {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(element).css('background-image', 'url("x.png")')
    console.log("x")
}

const printO = (element) => {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(element).css('background-image', 'url("o.png")')
}
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".cell").click((e) => {
    if(jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).css('background-image') !== 'none') { // Checks if already clicked before
        return;
    }
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()("#resetbtn").click(() => {
